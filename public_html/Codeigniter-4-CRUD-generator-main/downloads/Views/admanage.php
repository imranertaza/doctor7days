        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ad Manage</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
function edit(ad_id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #adId").val(response.ad_id);
			$("#edit-form #title").val(response.title);
			$("#edit-form #image").val(response.image);
			$("#edit-form #position").val(response.position);
			$("#edit-form #width").val(response.width);
			$("#edit-form #height").val(response.height);
			$("#edit-form #status").val(response.status);
			$("#edit-form #expireDate").val(response.expire_date);
			$("#edit-form #price").val(response.price);
			$("#edit-form #paidStatus").val(response.paid_status);
