...
class Roles extends BaseController
{
	...
	public function getAll()
	{
		...
		$result = $this->rolesModel->select('role_id, h_id, role, permission, is_default, createdBy, createdDtm, updatedby, updatedDtm, deleted, deletedRole')->findAll();
	...
	public function getOne()
	{
		...
		if ($this->validation->check($id, 'required|numeric')) {
			...
			$data = $this->rolesModel->where('role_id' ,$id)->first();
	...
	public function edit()
	{
        ...
        if ($this->validation->run($fields) == FALSE) {
            ...
            if ($this->rolesModel->update($fields['role_id'], $fields)) {
	...
	public function remove()
	{
		...
		if (!$this->validation->check($id, 'required|numeric')) {
			...
			if ($this->rolesModel->where('role_id', $id)->delete()) {
