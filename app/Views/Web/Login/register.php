            ...
            <div class="row">
                ...
                <div class="col-md-4 p-5 border">
                    <center><img class="img-fluid" src="<?php echo base_url(); ?>/assets/web/image/logo 200.png"
                                 alt=""/>
                    <h6 class="mt-3">Patient signUP</h6></center>
                    <form method="post" action="<?php echo base_url('Web/login/register_action')?>">
                        ...
                        <div class="input-group mb-3 ">
                            ...
                            <a href="<?php echo base_url('Web/Login')?>" class="btn btn-outline-secondary btn-block">Login</a>
                        </div>
                    </form>
