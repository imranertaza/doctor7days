...
function edit(prod_cat_id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #parentProCatId").val(response.parent_pro_cat_id);
			$("#edit-form #productCategory").val(response.product_category);
