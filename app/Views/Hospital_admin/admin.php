...
$(function () {
	$('#data_table').DataTable({
		...
		"responsive": true,
		"ajax": {
			"url": '<?php echo base_url('hospital_admin/'.$controller.'/getAll') ?>',			
			"type": "POST",
			"dataType": "json",
			async: "true"
		}	  
...
function add() {
	...
	$.validator.setDefaults({
		...
		submitHandler: function(form) {
			...
			$.ajax({
				url: '<?php echo base_url('hospital_admin/'.$controller.'/add') ?>',						
				type: 'post',
...
function edit(user_id) {
	$.ajax({
		url: '<?php echo base_url('hospital_admin/'.$controller.'/getOne') ?>',
		type: 'post',
		data: {
			user_id: user_id
		},
		...
		success: function(response) {
			...
			$.validator.setDefaults({
				...
				submitHandler: function(form) {
					...
					$(".text-danger").remove();
					$.ajax({
						url: '<?php echo base_url('hospital_admin/'.$controller.'/edit') ?>' ,						
						type: 'post',
						data: form.serialize(), 
						dataType: 'json',
						beforeSend: function() {
...
function remove(user_id) {	
	Swal.fire({
	  ...
	  if (result.value) {
		$.ajax({
			url: '<?php echo base_url('hospital_admin/'.$controller.'/remove') ?>',
			type: 'post',
			data: {
				user_id: user_id
			},
