				...
				<div class="modal-body">
					<form id="add-form" class="pl-3 pr-3">								
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="patId"> Pat id: <span class="text-danger">*</span> </label>
									<input type="number" id="patId" name="patId" class="form-control" placeholder="Pat id" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="date" id="date" name="date" class="form-control" dateISO="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="serialNumber" name="serialNumber" class="form-control" placeholder="Serial number" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
