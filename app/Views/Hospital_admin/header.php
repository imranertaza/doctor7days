    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link"  href="<?php echo base_url('Hospital_admin/Message')?>">
                    <i class="far fa-comments"></i>
                    <?php $hCatId = get_data_by_id('hospital_cat_id','hospital','h_id',newSession()->h_Id); if ($hCatId == 1){ ?>
                    <span class="badge badge-danger navbar-badge"><?php echo count_hospital_notification(newSession()->h_Id);?></span>
                    <?php } if ($hCatId == 2){ ?>
                    <span class="badge badge-danger navbar-badge"><?php echo count_diagnostics_notification(newSession()->h_Id);?></span>
                    <?php } if ($hCatId == 3){ ?>
                    <span class="badge badge-danger navbar-badge"><?php echo count_both_notification(newSession()->h_Id);?></span>
                    <?php } ?>
