			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="add-form" class="pl-3 pr-3">								
                        <div class="row">
 							<input type="hidden" id="ambId" name="ambId" class="form-control" placeholder="Amb id" maxlength="11" required>
						</div>
						<div class="row">
							<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" id="oxygen" name="oxygen" class="form-control" placeholder="Oxygen" >
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="carModelName"> Car model name: <span class="text-danger">*</span> </label>
									<input type="text" id="carModelName" name="carModelName" class="form-control" placeholder="Car model name" maxlength="155" required>
								</div>
							</div>
						</div>
						<div class="row">
...
function edit(amb_id) {
	$.ajax({
		...
		success: function(response) {
			...
			$("#edit-form #ambId").val(response.amb_id);
			$("#edit-form #mobile").val(response.mobile);
			$("#edit-form #password").val(response.password);
			$("#edit-form #contactName").val(response.contact_name);
			$("#edit-form #oxygen").val(response.oxygen);
			$("#edit-form #ac").val(response.ac);
			$("#edit-form #carModelName").val(response.car_model_name);
