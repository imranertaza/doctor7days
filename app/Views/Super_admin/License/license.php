                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="division"> Hospital: </label>
                                    <select class="form-control" name="h_id" required >
                                        <option value="">Please Select</option>
                                        <?php foreach ($hospital as $item){ ?>
                                            <option value="<?php echo $item->h_id;?>"><?php echo $item->name;?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="zila"> Start Date: </label>
                                    <input type="date" class="form-control" name="start_date">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="upazila"> End Date: </label>
                    ...
                    <form id="edit-form" class="pl-3 pr-3">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="lic_id" id="lic_id">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
    ...
    function edit(lic_id) {
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#edit-form #lic_id").val(response.lic_id);
                $("#edit-form #h_id").val(response.h_id);
