...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Indian Hospital</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Indian Hospital</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8 mt-2">
                                <h3 class="card-title">Indian Hospital</h3>
                            </div>
                            <div class="col-md-4">
                                <?php if ($create == 1) { ?>
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <a href="<?php echo base_url('Super_admin/Indianhospital/branch')?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Branch</a>
