                ...
                <div class="card">
                    ...
                    <div class="card-body" style="font-size: 14px;">
                        <div class="row invoice-info" >
                            ...
                            <!-- /.col -->
                            <?php
                                if (!empty($order->patient_id)) {
                                    $customer = get_data_by_id('name', 'patient', 'pat_id', $order->patient_id);
                                } else {
                                    $customer = get_data_by_id('name', 'hospital', 'h_id', $order->h_id);
                                }
                            ?>
                            <div class="col-sm-4 invoice-col">
                                To
                            ...
                            <div class="col-sm-4 invoice-col" style="text-transform: capitalize;">
                                ...
                                <b>Status:</b> <?php //echo orderStatusView($order->status); ?>
...
<script>
    ...
    function orderStatusUpdate(status,orderId){
        $.ajax({
            url: "<?= base_url('Super_admin/Orders/orderStatusUpdate') ?>",
            type: "POST",
            cache: false,
