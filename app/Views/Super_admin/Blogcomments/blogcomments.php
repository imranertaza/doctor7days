			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="add-form" class="pl-3 pr-3">								
                        <div class="row">
 							<input type="hidden" id="blogCommentId" name="blogCommentId" class="form-control" placeholder="Blog comment id" maxlength="11" required>
						</div>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="postId"> Post id: <span class="text-danger">*</span> </label>
									<input type="number" id="postId" name="postId" class="form-control" placeholder="Post id" maxlength="11" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="comment"> Comment: <span class="text-danger">*</span> </label>
									<textarea cols="40" rows="5" id="comment" name="comment" class="form-control" placeholder="Comment" required></textarea>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="patientId"> Patient id: <span class="text-danger">*</span> </label>
									<input type="number" id="patientId" name="patientId" class="form-control" placeholder="Patient id" maxlength="11" number="true" required>
								</div>
							</div>
						</div>
						<div class="row">
  ...
  <script>
      ...
      function edit(blog_comment_id) {
          $.ajax({
              ...
              success: function(response) {
                  ...
                  $("#edit-form #blogCommentId").val(response.blog_comment_id);
      ...
      function remove(blog_comment_id) {
          Swal.fire({
