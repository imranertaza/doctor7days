            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add-form" class="pl-3 pr-3">
                        <div class="row">
                            <input type="hidden" id="pymntMethodId" name="pymntMethodId" class="form-control" placeholder="Pymnt method id" maxlength="11" required>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="typeName"> Type name: <span class="text-danger">*</span> </label>
                                    <input type="text" id="typeName" name="typeName" class="form-control" placeholder="Type name" maxlength="155" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
...
<script>
    ...
    function edit(pymnt_method_id) {
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#edit-form #typeName").val(response.type_name);
    ...
    function remove(pymnt_method_id) {
        Swal.fire({
