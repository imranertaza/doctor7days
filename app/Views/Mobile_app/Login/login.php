<section class="back" >
    ...
    <div class="row">
        ...
        <div class="col-12 p-3 "  style="margin-bottom: 86px; margin-top: 10px;">
            <a href="<?php echo base_url('Mobile_app/Patient/register')?>" class="btn-signup" style="padding: 12px 125px 12px 126px ;">Sign UP</a>
        </div>
