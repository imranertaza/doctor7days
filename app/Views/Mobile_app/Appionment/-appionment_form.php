    ...
    <div class="row">
        ...
        <div class="col-12 p-3 row">
            <div class="col-6" style="padding-right: unset;">
                <a href="<?php echo base_url('mobile_app/appionment')?>" class="btn btn-info" style="display: block;width: 100%;background-color: rgba(0,174,214,1);">Bangladesh</a>
            </div>
            <div class="col-6" style="padding-left: unset;">
                <a href="<?php echo base_url('mobile_app/appionment/indian')?>" class="btn btn-info" style="display: block;width: 100%; background-color: rgba(0,174,214,1);">Indian</a>
            </div>
        </div>
        <div class="col-12 p-3 ">
